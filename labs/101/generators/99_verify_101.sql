...
-- Only objects SETUP creates are checked here. TERMINAL_TELEMETRY, CATEGORY_BY_REGION,
-- CATEGORY_BY_REGION_BACKUP and TERMINAL_EVENT_SUMMARY are deliberately absent: attendees
-- build those during the labs, so checking them before the labs fails on a fresh account.
INSERT INTO FISERV_101_DB.PUBLIC.VERIFY_RESULTS
